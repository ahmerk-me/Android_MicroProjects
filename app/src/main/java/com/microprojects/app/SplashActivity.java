...
import com.microprojects.app.classes.AlertDialogManager;
import com.microprojects.app.classes.ConnectionDetector;
...
public class SplashActivity extends Activity {
    ...
    LanguageSessionManager mLangSessionManager;
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if (!isBackButtonPressed) {
                    Log.e("22222 ","Splash isFirstTime ===>>> " + sessionManager.isFirstTime());
                    if(sessionManager.isFirstTime()){

                        startActivity(new Intent(SplashActivity.this, MainActivity.class).putExtra("fragType", 0));
